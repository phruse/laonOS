...
#pragma once
#ifndef LAONOS_BOOT_INCLUDE_SRC_INFO_H
#define LAONOS_BOOT_INCLUDE_SRC_INFO_H

#define OS_KERNEL_NAME "KERNEL"

#define OS_MODULE_MAX 10

#define OS_STACK_SIZE 2048 //OS's stack size (2kb)
...
#endif // LAONOS_BOOT_INCLUDE_SRC_INFO_H
